...
files = os.listdir(folderPath)  # 取得資料夾內所有內容
# 這時候資料夾可能包含其他檔案，我們只需要.md的檔案
print(files)
files_name = []  # 新增列表來存放.md的檔案
for f in files:  # 逐一檢查所有檔案，看看能否以.md結尾
